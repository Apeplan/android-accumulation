...
public class StateLoadingView extends View {
    ...
    public StateLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.StateLoadingStyle);
    }
    ...
    public StateLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable
                .StateLoadingView, defStyleAttr, 0);
        mSize = array.getDimensionPixelSize(R.styleable.StateLoadingView_state_loading_view_size,
                dp2px(context, 32));
